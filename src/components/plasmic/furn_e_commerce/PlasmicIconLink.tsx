...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: qQBhU6fwkMqs/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg___7Hiks)}
              role={"img"}
            />
          ),
