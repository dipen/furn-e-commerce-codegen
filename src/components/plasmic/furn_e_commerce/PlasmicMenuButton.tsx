...
import * as sty from "./PlasmicMenuButton.module.css"; // plasmic-import: 3vL0wxDMBuTj/css

import BarsIcon from "./icons/PlasmicIcon__Bars"; // plasmic-import: mg_lcNHRg6Cy/icon
import TimesIcon from "./icons/PlasmicIcon__Times"; // plasmic-import: uYjFv0e035Lc/icon
    ...
    >
      ...
      >
        {(hasVariant(variants, "expanded", "expanded") ? false : true) ? (
          <BarsIcon
            className={classNames(defaultcss.all, sty.svg__hcf6W, {
              [sty.svg__expanded__hcf6WLh2Cr]: hasVariant(
                variants,
                "expanded",
                "expanded"
              )
        ...
        {(hasVariant(variants, "expanded", "expanded") ? true : false) ? (
          <TimesIcon
            className={classNames(defaultcss.all, sty.svg__lHhAt, {
              [sty.svg__expanded__lHhAtLh2Cr]: hasVariant(
                variants,
                "expanded",
                "expanded"
              )
