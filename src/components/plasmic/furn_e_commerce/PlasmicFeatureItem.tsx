...
import * as sty from "./PlasmicFeatureItem.module.css"; // plasmic-import: CGmwQPHw__o/css
...
function PlasmicFeatureItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.freeBox__wzrQl)}>
        <div className={classNames(defaultcss.all, sty.freeBox___7CsaZ)} />

        <div className={classNames(defaultcss.all, sty.freeBox__w9F6)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox__nej2I)}
          >
            <div
            ...
            <div className={classNames(defaultcss.all, sty.freeBox__rJQza)}>
              <div
                className={classNames(
                  defaultcss.all,
                  defaultcss.__wab_text,
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox__vcjZg)}
            >
              <LinkButton
