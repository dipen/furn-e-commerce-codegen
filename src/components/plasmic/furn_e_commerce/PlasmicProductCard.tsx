...
import * as sty from "./PlasmicProductCard.module.css"; // plasmic-import: 0x0Vn3klYRuA/css

import ShoppingCartIcon from "./icons/PlasmicIcon__ShoppingCart"; // plasmic-import: hHwdBo8G_pB7/icon
import HeartOIcon from "./icons/PlasmicIcon__HeartO"; // plasmic-import: Xg0Jp8zx-KfJ/icon
import ExpandIcon from "./icons/PlasmicIcon__Expand"; // plasmic-import: oja6rweii_BL/icon
...
function PlasmicProductCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.freeBox___3DTbI)}>
        {p.renderPlasmicSlot({
          defaultContents: (
            <img
              alt={""}
              className={classNames(defaultcss.img, sty.img__croA)}
              src={f1PIq79SbpZz2D}
            />
          ),
        ...
        {(hasVariant(variants, "onSale", "onSale") ? true : false) ? (
          <div
            className={classNames(defaultcss.all, sty.freeBox__zFtUy, {
              [sty.freeBox__onSale__zFtUyfwnxy]: hasVariant(
                variants,
                "onSale",
                "onSale"
              )
        ...
        {(triggers.hover_root ? true : false) ? (
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox__xe3UA)}
          >
            <ShoppingCartIcon
              className={classNames(defaultcss.all, sty.svg__kee1H)}
              role={"img"}
            />
            ...
            <HeartOIcon
              className={classNames(defaultcss.all, sty.svg__ui9Rp)}
              role={"img"}
            />

            <ExpandIcon
              className={classNames(defaultcss.all, sty.svg__dwoFn)}
              role={"img"}
            />
          </p.Stack>
        ) : null}
      ...
      {(hasVariant(variants, "withReviews", "withReviews") ? true : false)
        ? p.renderPlasmicSlot({
            defaultContents: (
              <Ratings
                className={classNames("__wab_instance", sty.ratings__wlQo0)}
              />
            ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__wgU)}
      >
        {p.renderPlasmicSlot({
